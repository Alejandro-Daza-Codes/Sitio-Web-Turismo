    ...
    <div id="contenedor" >
        <div class="contain">
            <div class="row">
                ...
                <form name="frm_ruta" id="frm_ruta" method="POST" action="savecambiosRuta.php" enctype="multipart/form-data">
                    <input type="text" name="id" id="id" value="<?php echo $id;?>" hidden>
                <fieldset>
                    <div class="form-row">
                        <div class="col-md-6 mb-2">
                            <label><b>Nombre de Ruta</b></label>
                            <input type="text" name="name_ruta" id="name_ruta" value ="<?php echo $data_ruta['nombre_ruta']?>" class="rounded-input">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label><b>Precio</b></label>
                            <input type="number" name="precio" id="precio" value ="<?php echo $data_ruta['precio']?>" class="rounded-input">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-2">
                            <label><b>Punto de Encuentro</b></label>
                            <input type="text" name="p_encuentro" id="p_encuentro" value ="<?php echo $data_ruta['p_encuentro']?>" class="rounded-input">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label><b>Contacto</b></label>
                            <input type="text" name="contact" id="contact" value ="<?php echo $data_ruta['contacto']?>" class="rounded-input">
                        </div>
                    </div>        
                    <div class="form-row">
                        <div class="col-md-6 mb-2">
                            <label><b>Fecha inicial</b></label>
                            <input type="date" name="fecha_ini" id="fecha_ini" value ="<?php echo $data_ruta['fecha_ini']?>" class="rounded-input">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label><b>Fecha Final</b></label>
                            <input type="date" name="fecha_fin" id="fecha_fin" value ="<?php echo $data_ruta['fecha_fin']?>" class="rounded-input">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-2">
                            <label><b>Duración de la Ruta</b></label>
                            <input type="text" name="duracion" id="duracion" value ="<?php echo $data_ruta['duracion']?>" class="rounded-input">
                        </div>
                        <div class="col-md-6">
                            <label><b>Descripción de la Ruta</b></label>
                            <textarea name="descripcion" id="descripcion" rows="2" cols="70" class="rounded-input"><?php echo $data_ruta['descripcion']?></textarea>
                        </div>
                    </div>   
                ...
                <button class="read_more" style="margin-top:12px;" onclick="edit_ruta();">Guardar</button>
        </div>
    </div>
